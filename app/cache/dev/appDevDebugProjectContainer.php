...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'db_dscorp', 'user' => 'root', 'password' => 'dscorp', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('dscorpsantos');
        $a->setPassword('HUASTEKITO2015');
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a09039832909f30b6c41816d5e9de282');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => '',
            'database_name' => 'db_dscorp',
            'database_user' => 'root',
            'database_password' => 'dscorp',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'dscorpsantos',
            'mailer_password' => 'HUASTEKITO2015',
            'locale' => 'en',
            'secret' => 'a09039832909f30b6c41816d5e9de282',
            ...
            'kernel.secret' => 'a09039832909f30b6c41816d5e9de282',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dscorpsantos',
            'swiftmailer.mailer.default.transport.smtp.password' => 'HUASTEKITO2015',
